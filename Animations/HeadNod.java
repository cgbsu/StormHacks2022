public class HeadNod extends Animation
{
    public static final float DefaultMaxTimeFinal = 2.0f;
    public String name() { return "HeadNod"; }
    public float speed() { return 1f; }
    Vector2 defaultPosition;

    Transform head;
    public HeadNod (Transform head) {
        this.head = head;
    ...
    public void OnUpdate(float deltaTime)
    {
        ...
        head.position = new Vector2(defaultPosition.x + nodAmmount, defaultPosition.y);
